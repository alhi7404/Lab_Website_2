...
function loadStatsPage(){
	...
	for(rowCounter=2; rowCounter<table.rows.length; rowCounter++){
		cuScore = parseInt(table.rows[rowCounter].cells[2].innerHTML);
		oppScore = parseInt(table.rows[rowCounter].cells[3].innerHTML);
		if(cuScore>oppScore){
...
function loadPlayersPage(){
	...
	for(var i = 0; i<players.length; i++){
		selectionText += '<a href="#" onclick="switchPlayers('+ i +')">' + players[i].name + '</a>' + '<br>';
	}
